...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Status:</label>
                                <select type="text" name="statusFilter" id="statusFilter" class="form-control">
                                    <option value="">Please Select Status</option>
                                    <option value="Cleaned">Cleaned</option>
                                    <option value="Partially Cleaned">Partially Cleaned</option>
    ...
    <script>
        $('#header_heading').html("STATUS WISE REPORT");
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('a[href="statusReport.php"]').addClass("active");
        });
    </script>
     <script>
    hideLoader();
                ...
                querySnapshot.forEach(function(doc) {
                    ...
                    db.collection("SSWMB/" + childKey + "/Evaluation").get().then(function(subQuerySnapshot) {
                        subQuerySnapshot.forEach(function(subDoc) {
                            ...
                            if(subDoc.data() != undefined && subDoc.data().Status == $('#statusFilter').val()) {

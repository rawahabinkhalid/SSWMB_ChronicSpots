...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Supervisor Wise Report</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select type="text" name="supervisor" id="supervisor" class="form-control">
    ...
    <script>
        $('#header_heading').html("SUPERVISOR WISE REPORT");
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('a[href="supervisorReport.php"]').addClass("active");
        });
    </script>
    <script>
    showLoader();
    ...
    <script>
        $('#search').on('click', function() {
            ...
            if($('#supervisor').val() == '') {
                alert('Kindly select Supervisor');
                return;
            }
            db.collection("SSWMB").doc($('#supervisor').val()).get().then(function(doc) {
                content = '';
                serialNo = 1;
    ...
    <script>
    db.collection("SSWMB").orderBy("empcode").get().then(function(querySnapshot) {
        var options = '<option value="">Please Select Supervisor</option>';
        querySnapshot.forEach(function(doc) {
            var childKey = doc.id;
            if(doc.data().empcode !== undefined && doc.data().nameofofficer !== undefined)
            options += '<option value="' + childKey + '">' + doc.data().empcode + " - " + doc.data().nameofofficer + '</option>';
        });

...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>UC:</label>
                                <select type="text" name="uc" id="uc" class="form-control">
    ...
    <script>
        $('#header_heading').html("LOCATION WISE REPORT");
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('a[href="locationReport.php"]').addClass("active");
        });
    </script>
    <script>
    showLoader();
                    ...
                    db.collection("SSWMB/" + childKey + "/Evaluation").get().then(function(subQuerySnapshot) {
                        subQuerySnapshot.forEach(function(subDoc) {
                            ...
                            db.collection("SPOTS/").doc(subDoc.data().SpotId).get().then(function(microDoc) {
                                showLoader();
                                if(microDoc.data() != undefined && microDoc.data().district == district && (zone == '' || microDoc.data().zone == zone) && (uc == '' || microDoc.data().uc == uc)) {
